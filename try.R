...
a_match <- intersect(as.integer(as.vector(a_zero_sale_stores$Store)),as.integer(as.vector(a_test_stores$Store)))
...
#So far we have checked out sales figures with respect to promo days, open/closed, stateholidays
#schoolholidays,year and month variables.
